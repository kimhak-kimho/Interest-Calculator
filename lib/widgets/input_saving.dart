...
import 'package:interest_calculator/widgets/result_saving.dart';
import 'package:flutter/services.dart';

class InputSaving extends StatefulWidget {
  final String title;

  const InputSaving({super.key, required this.title});

  @override
  State<InputSaving> createState() => _InputScreenState();
}

class _InputScreenState extends State<InputSaving> {
            ...
            child: Column(
              children: [
                ...
                TextFormField(
                  ...
                  decoration: const InputDecoration(
                    labelText: 'អត្រាការប្រាក់ប្រចាំឆ្នាំ (%)',
                    hintText: 'បញ្ចូលអត្រាការប្រាក់ប្រចាំឆ្នាំជាភាគរយ',
                    hintStyle: TextStyle(
                      fontFamily: 'Misan',
                      fontSize: 14,
                      color: Colors.grey,
